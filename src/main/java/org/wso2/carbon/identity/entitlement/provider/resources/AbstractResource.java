...
public class AbstractResource {
    public String identifyOutputFormat(String format) {
        if (format == null || ("*/*").equals(format) || ((format != null) && (format.startsWith(EntitlementConstants.APPLICATION_JSON)))) {
            return EntitlementConstants.APPLICATION_JSON;
        } else {
            return format;
        }
    }
    ...
    public String identifyInputFormat(String format) {
        if (format == null || ("*/*").equals(format) ||
                ((format != null) && (format.startsWith(EntitlementConstants.APPLICATION_JSON)))) {
            return EntitlementConstants.APPLICATION_JSON;
        } else {
            return format;
        }
